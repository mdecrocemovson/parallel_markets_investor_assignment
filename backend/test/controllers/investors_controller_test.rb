...
class InvestorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create investor" do
    assert_difference('Investor.count') do
      post investors_url, params: { investor: { firstName: @investor.firstName, lastName: @investor.lastName } }
    end
  ...
  test "should update investor" do
    patch investor_url(@investor), params: { investor: { firstName: @investor.firstName, lastName: @investor.lastName } }
